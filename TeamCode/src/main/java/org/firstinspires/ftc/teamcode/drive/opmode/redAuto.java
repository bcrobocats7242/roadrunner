...
public class redAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory LEFT_PURPLE_SCORE = drive.trajectoryBuilder(startPose)
                .splineToLinearHeading(new Pose2d(10, -31, Math.toRadians(0)), Math.toRadians(0))
                .build();
        ...
        Trajectory RIGHT_PURPLE_SCORE = drive.trajectoryBuilder(startPose)
                .splineToLinearHeading(new Pose2d(27, -31, Math.toRadians(0)), Math.toRadians(0))
                .build();
        Trajectory LEFT_YELLOW_SCORE = drive.trajectoryBuilder(poseLeft)
                .splineToLinearHeading(new Pose2d(52.6, -28, Math.toRadians(180)), Math.toRadians(0))
                .build();
        Trajectory CENTER_YELLOW_SCORE = drive.trajectoryBuilder(poseCenter)
                .splineToLinearHeading(new Pose2d(52.6, -31, Math.toRadians(180)), Math.toRadians(0))
                .build();
        ...
        if (!isStopRequested()) {
           ...
           drop.setPosition(0);
            ...
            useSlide(1, 1350);
        //    drive.followTrajectory(PICK_UP_WHITE);
